...
public class Fragment1 extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        String countyCode = getActivity().getIntent().getStringExtra("county_code");
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.switch_city:
                Intent intent = new Intent(getActivity().getApplicationContext(), ChooseAreaActivity.class);
    ...
    private void showWeather(){
        ...
        Intent intent = new Intent(getActivity().getApplicationContext(), AutoUpdateService.class);
